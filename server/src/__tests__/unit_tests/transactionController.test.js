...
describe('getTransactions', () => {
    it('should return filtered transactions', async () => {
        const mockTransactions = [
            { user: { id: 'testUser' }, type: 'Expense', category: 'Food', amount: 100 },
            { user: { id: 'testUser' }, type: 'Expense', category: 'Car', amount: 200 }
        ];
    ...
    it('should handle errors and return 500', async () => {
        ...
        expect(res.json).toHaveBeenCalledWith({ message: 'Error fetching transactions', error: err });
    });
});
